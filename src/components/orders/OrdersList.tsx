...
import { getOrdersByRestaurant, updateOrderStatus, FirestoreOrder } from '@/lib/firestore';
...
export function OrdersList() {
  ...
  useEffect(() => {
    const loadOrders = async () => {
      ...
      try {
        setLoading(true);
        const firestoreOrders = await getOrdersByRestaurant(currentRestaurant.id);

        // Convert Firestore orders to local Order format
        ...
        console.log(`Loaded ${convertedOrders.length} orders for restaurant ${currentRestaurant.id}`);
      } catch (error) {
