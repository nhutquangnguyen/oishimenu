...
interface DisabledAccountNotificationProps {
  email: string;
  onReturnToLogin: () => void;
}

export function DisabledAccountNotification({ email, onReturnToLogin }: DisabledAccountNotificationProps) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center pb-4">
          ...
          <CardTitle className="text-xl text-red-600">Account Disabled</CardTitle>
